...
namespace OLKI.Toolbox.Widgets
{
    ...
    public partial class PictrueBoxCropSimple : PictureBox
    {
        ...
        /// </summary>
        private Rectangle _cropAreaSelection;
        /// <summary>
        ...
        public Image CropedImage
        {
            get
            {
                try
                {
                    ...
                    return Modify.Crop(this.Image, this.CropAreaFit);
                }
                catch (Exception ex)
                {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
                this._cropAreaSelection.Width = e.X - this._cropAreaSelection.X;
                this._cropAreaSelection.Height = e.Y - this._cropAreaSelection.Y;
                this.Refresh();
            }
            base.OnMouseMove(e);
        }
