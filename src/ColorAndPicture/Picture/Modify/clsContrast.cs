...
namespace OLKI.Toolbox.ColorAndPicture.Picture
{
    ...
    public static partial class Modify
    {
        ...
        /// <returns>The image with modified contrast or NULL if an exception was thrown</returns>
        public static Image Contrast(Image image, int contrast)
        {
            return Contrast(image, contrast, out _);
        }
        ...
        /// <returns>The image with modified contrast or NULL if an exception was thrown</returns>
        public static Image Contrast(Image image, int contrast, out Exception exception)
        {
            try
            {
                exception = null;
