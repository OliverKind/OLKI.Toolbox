...
namespace OLKI.Toolbox.DirectoryAndFile
{
    ...
    public static class Directory
    {
        ...
        public static bool Copy(string sourcePath, string destPath, bool copySubDirs)
        {
            ...
            {
                MessageBox.Show(string.Format(clsDirectory_Stringtable._0x0006m, new object[] { sourcePath, destPath, ex.Message }), src.DirectroyAndFile.clsDirectory_Stringtable._0x0006c, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        #endregion
        ...
        public static bool Create(string path, string templatePath)
        {
            ...
            {
                MessageBox.Show(string.Format(clsDirectory_Stringtable._0x0005m, new object[] { path, ex.Message }), src.DirectroyAndFile.clsDirectory_Stringtable._0x0005c, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        #endregion
        ...
        public static bool Delete(string path, bool showSecurityQuestion)
        {
            ...
            {
                MessageBox.Show(string.Format(clsDirectory_Stringtable._0x0003m, new object[] { path, ex.Message }), src.DirectroyAndFile.clsDirectory_Stringtable._0x0003c, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        #endregion
